...
void entityclass::createentity(int xp, int yp, int t, int meta1, int meta2, int p1, int p2, int p3, int p4)
{
    ...
    case 25: //Trophies
        ...
        {
        case 1:
            if(game.timetrialsaves[0].best_rank >= 3)
            {
            ...
            break;
        case 2:
            if(game.timetrialsaves[1].best_rank >= 3)
            {
            ...
            break;
        case 3:
            if(game.timetrialsaves[2].best_rank >= 3)
            {
                entity.tile = 184 + meta1;
                entity.colour = 33;
            }
            break;
        case 4:
            if(game.timetrialsaves[3].best_rank >= 3)
            {
                entity.tile = 184 + meta1;
                entity.colour = 32;
            }
            break;
        case 5:
            if(game.timetrialsaves[4].best_rank >= 3)
            {
                entity.tile = 184 + meta1;
                entity.colour = 34;
            }
            break;
        case 6:
            if(game.timetrialsaves[5].best_rank >= 3)
            {
                entity.tile = 184 + meta1;
                entity.colour = 30;
            }
